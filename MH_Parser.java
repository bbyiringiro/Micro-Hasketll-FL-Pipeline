...
class MH_Parser extends GenParser implements PARSER {
    ...
    String[] tableEntry(String nonterm, String tokClass) {
        // this sequence of nested ifs that check every terminal and returns a correct productions from my parse table
        if (nonterm.equals("#Prog")) {
            ...
            if (tokClass.equals("(") || tokClass.equals("Integer") || tokClass.equals("Bool"))
            ...
            if (tokClass.equals(";") || tokClass.equals(")") || tokClass.equals("then") || tokClass.equals("else"))
                return epsilon;
            else if (tokClass.equals("=="))
                return eqeq_Exp1;
            else if (tokClass.equals("<="))
            ...
            if (tokClass.equals(";") || tokClass.equals(")") || tokClass.equals("==") || tokClass.equals("<=")
                    || tokClass.equals("then") || tokClass.equals("else"))
                return epsilon;
            else if (tokClass.equals("+"))
            ...
            if (tokClass.equals(";") || tokClass.equals(")") || tokClass.equals("==") || tokClass.equals("<=")
                    || tokClass.equals("then") || tokClass.equals("else") || tokClass.equals("else")
                    || tokClass.equals("+") || tokClass.equals("-"))
                return epsilon;
            else if (tokClass.equals("VAR") || tokClass.equals("NUM") || tokClass.equals("BOOLEAN")
                    || tokClass.equals("("))
                return Exp3_Rest2;
            else
                return null;
